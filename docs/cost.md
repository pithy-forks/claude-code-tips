...
> **always reference [anthropic pricing](https://docs.anthropic.com/en/docs/about-claude/models) for current rates.** this snapshot goes stale fast. last verified may 13 2026 (claude code v2.1.140). check official pricing before making cost decisions.
